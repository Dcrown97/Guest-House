            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Reserve a Room</li>
                    </ol>
                </div>
            </div>
            <div class="row">
...
<p class="alert alert-info">{{ Session('warning') }}</p>
@endif
                            <form method="POST" id="form_sample_1"
                                ...
                                <div class="form-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            {{-- @dd($room) --}}
                                            <input type="text" readonly name="name" value="{{ $room->room !== null ? $room->room->name: $room->name }}" data-required="1"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="price" id="price" value="{{ $room->room != null? $room->room->price: $room->price }}" data-required="1"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" readonly name="status" value="{{ $room->room != null ? $room->room->status: $room->status }}" data-required="1"
                                                placeholder="5000" class="form-control input-height" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" required name="customer_name" data-required="1"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" required name="customer_phone" data-required="1"
